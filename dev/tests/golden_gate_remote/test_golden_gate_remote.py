"""End-to-end regression test for the Golden Gate Remote QGIS project."""

import pytest

from golden_gate_remote_case import SUITE
...
def test_golden_gate_remote_export_matches_reference(case):
    try:
