...
def _get_vent_str(utm_origin_py, utm_fire_origin_py):
...
def _get_mesh_str():
    return "\n".join(
        (
            ...
            "&MESH IJK=50,50,50 XB=-500.000,500.000,-500.000,500.000,-10.000,1000.000 /",
            "&TRNZ MESH_NUMBER=0 IDERIV=1 CC=0 PC=0.5 /",
