...
def write_case(
    ...
    content = "\n".join(
        (
            ...
            f"&VENT ID='Domain BC XMIN', MB='XMIN', SURF_ID='OPEN' /",
            f"&VENT ID='Domain BC XMAX', MB='XMAX', SURF_ID='OPEN' /",
            f"&VENT ID='Domain BC YMIN', MB='YMIN', SURF_ID='OPEN' /",
            f"&VENT ID='Domain BC YMAX', MB='YMAX', SURF_ID='OPEN' /",
            f"&VENT ID='Domain BC ZMAX', MB='ZMAX', SURF_ID='OPEN' /",
            f" ",
            f"! Fire origin",
            f"&SURF ID='Ignition', VEG_LSET_IGNITE_TIME=0., COLOR='RED' /",
            f"&VENT ID='Ignition point', XB={fire_x-5:.3f},{fire_x+5:.3f},{fire_y-5:.3f},{fire_y+5:.3f},{mesh_xb[4]:.3f},{mesh_xb[4]:.3f}, SURF_ID='Ignition', GEOM=T /",
            f" ",
            f"! Output quantities",
            ...
            f"&SURF ID='A01' RGB=255,254,212 VEG_LSET_FUEL_INDEX= 1 /",
            f"&SURF ID='A02' RGB=255,253,102 VEG_LSET_FUEL_INDEX= 2 /",
            f"&SURF ID='A03' RGB=236,212, 99 VEG_LSET_FUEL_INDEX= 3 /",
            f"&SURF ID='A04' RGB=254,193,119 VEG_LSET_FUEL_INDEX= 4 /",
            f"&SURF ID='A05' RGB=249,197, 92 VEG_LSET_FUEL_INDEX= 5 /",
            f"&SURF ID='A06' RGB=217,196,152 VEG_LSET_FUEL_INDEX= 6 /",
            f"&SURF ID='A07' RGB=170,155,127 VEG_LSET_FUEL_INDEX= 7 /",
            f"&SURF ID='A08' RGB=229,253,214 VEG_LSET_FUEL_INDEX= 8 /",
            f"&SURF ID='A09' RGB=162,191, 90 VEG_LSET_FUEL_INDEX= 9 /",
            f"&SURF ID='A10' RGB=114,154, 85 VEG_LSET_FUEL_INDEX=10 /",
            f"&SURF ID='A11' RGB=235,212,253 VEG_LSET_FUEL_INDEX=11 /",
            f"&SURF ID='A12' RGB=163,177,243 VEG_LSET_FUEL_INDEX=12 /",
            f"&SURF ID='A13' RGB=  0,  0,  0 VEG_LSET_FUEL_INDEX=13 /",
